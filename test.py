...
makroni = slaščičar.dodaj_sladico('makroni', date(2020, 7, 19), 10, dodatni_delavec)
mafini = slaščičar.dodaj_sladico('mafini', date(2020, 7, 19), 20, sestavine)
torta = slaščičar.dodaj_sladico('čokoladna_torta', date(2020, 6, 12), 100, sestavine, osebno)
